      ...
      <div class="container container-form-login mt-5" id="login-form">
        <div class="icon-box">
          <?php if ($_SERVER["REQUEST_METHOD"] == "POST") {
            $idUsuario = $_POST["id"]; // Mudei para garantir que o id correto está sendo utilizado
            ...
            if ($result->num_rows > 0) {
              ...
              <form action="../controladora/processar_editar_admin.php" method="POST" enctype="multipart/form-data" class="formulario-edicao">
                <input type="hidden" name="idUsuario" value="<?= $usuario["idUsuario"] ?>"> <!-- Corrigido para o nome correto -->
